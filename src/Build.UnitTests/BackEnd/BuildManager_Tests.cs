...
namespace Microsoft.Build.UnitTests.BackEnd
{
    ...
    public class BuildManager_Tests : IDisposable
    {
        ...
        [Fact]
        public void BuildParametersDefaultBuildRequestPriorityIsNormal()
        {
            new BuildParameters().BuildRequestPriority.ShouldBe(BuildRequestPriority.Normal);
        }

        [Theory]
        [InlineData("Low", BuildRequestPriority.Low)]
        [InlineData("Normal", BuildRequestPriority.Normal)]
        [InlineData("High", BuildRequestPriority.High)]
        [InlineData(" high ", BuildRequestPriority.High)]
        public void BuildParametersReadsBuildRequestPriorityFromEnvironment(string value, BuildRequestPriority expectedPriority)
        {
            _env.SetEnvironmentVariable(CoordinatorConstants.BuildRequestPriorityEnvVarName, value);

            new BuildParameters().BuildRequestPriority.ShouldBe(expectedPriority);
        }
        ...
        [InlineData("Urgent")]
        [InlineData("2")]
        public void BuildParametersUsesNormalPriorityWhenEnvironmentIsMissingOrInvalid(string value)
        {
            _env.SetEnvironmentVariable(CoordinatorConstants.BuildRequestPriorityEnvVarName, value);
        ...
        [Fact]
        public void BuildParametersCloneCopiesBuildRequestPriority()
        {
            BuildParameters parameters = new()
            {
                BuildRequestPriority = BuildRequestPriority.High
            };

            parameters.Clone().BuildRequestPriority.ShouldBe(BuildRequestPriority.High);
        }

        [Fact]
        public void BuildParametersRejectsInvalidBuildRequestPriority()
        {
            BuildParameters parameters = new();

            Should.Throw<ArgumentOutOfRangeException>(() => parameters.BuildRequestPriority = (BuildRequestPriority)42);
        }

        [Fact]
        public async System.Threading.Tasks.Task BuildManagerPassesBuildRequestPriorityToCoordinator()
        {
            string pipeName = $"msbuild-coordinator-buildmanager-test-{Guid.NewGuid():N}";
...
");
            ...
            BuildParameters parameters = _parameters.Clone();
            parameters.BuildRequestPriority = BuildRequestPriority.High;
